...
public static void main(String[] args) throws Exception{
    ...
    if(searchtypeText.equalsIgnoreCase("Advanced"))
    {
    	driver.findElement(By.xpath("//a[contains(@class,'switcher-item active')]")).click();
    	  driver.findElement(By.id("advanced-search")).sendKeys("affectedVersion in (21.6, 21.6.100, 21.6.300) AND \"Is Triaged?\" = Yes AND reporter in (currentUser(), kabilaa, pramodhv, samili, kunchijk, gthameem) order by created DESC");
    }	
...
//    Thread.sleep(5000);
    ...
    driver.findElement(By.xpath("//button[@class='aui-button aui-button-primary search-button']")).click();
            ...
            email.append("<br />" + "<br />");
            email.append("Here is the bugs which is triaged in QS Team,");
            email.append("<br />" + "<br />");
            email.append("Triaged Report as of" + " " + dateFormat.format(date)
                    + " ");
            email.append("<br />" + "<br />");
...
message.setSubject("Triaged Bug Report");
