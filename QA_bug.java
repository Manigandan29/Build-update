...
public static void main(String[] args) throws Exception{
    ...
    if(searchtypeText.equalsIgnoreCase("Advanced"))
    {
    	driver.findElement(By.xpath("//a[contains(@class,'switcher-item active')]")).click();
    	  driver.findElement(By.id("advanced-search")).sendKeys("created >= -18h AND reporter in (kosoba, reddyv)");
    }	
...
//    Thread.sleep(5000);
    ...
    driver.findElement(By.xpath("//button[@class='aui-button aui-button-primary search-button']")).click();
            ...
            email.append("<br />" + "<br />");
            email.append("Please refer the bugs raised by QA,");
            email.append("<br />" + "<br />");
    	...
    	driver.findElement(By.xpath("//*[@id=\"content\"]/div[1]/div[3]/div/div/div/div/div/div/div/div[1]/div[1]/div/div[1]/div[2]/div/ol/li["+i+"]")).click();
    	Thread.sleep(3000);
    	...
    	Reporter = driver.findElement(By.xpath(".//ul[1]/li[1]/dl[2]/dd[1]/span[1]/span[1]")).getText();
...
message.setSubject("Bug Reported by QA");
